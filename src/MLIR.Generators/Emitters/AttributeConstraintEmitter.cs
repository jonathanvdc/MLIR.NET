...
internal static class AttributeConstraintEmitter
{
    ...
    private static string GetBaseType(AttributeConstraintKind kind)
    {
        return kind switch
        {
            ...
            AttributeConstraintKind.DenseFloatingPointArrayAttribute => "DenseFloatingPointArrayAttributeValue",
    ...
    private static string? GetAssemblyFormatType(AttributeConstraintKind kind)
    {
        return kind switch
        {
            ...
            AttributeConstraintKind.DenseFloatingPointArrayAttribute => "DenseFloatingPointArrayAttributeAssemblyFormat",
    ...
    private static string? GetPrimitiveBaseConstructor(AttributeConstraintKind kind)
    {
        return kind switch
        {
            ...
            AttributeConstraintKind.DenseFloatingPointArrayAttribute => "context, StructuredAttributeSemanticDecoder.DecodeFloatingPointItems(((DenseArrayAttributeValueSyntax)context.Syntax).Items.Items)",
    ...
    private static string? GetValueConstructorParameter(AttributeConstraintKind kind)
    {
        return kind switch
        {
            ...
            AttributeConstraintKind.DenseFloatingPointArrayAttribute => "global::System.Collections.Generic.IReadOnlyList<double>",
            _ => null,
        };
    }
}
