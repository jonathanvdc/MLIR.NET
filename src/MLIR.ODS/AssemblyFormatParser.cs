...
/// <summary>
/// Parses declarative MLIR ODS assembly format strings into <see cref="AssemblyFormatModel"/> instances.
/// </summary>
public static class AssemblyFormatParser
{
    /// <summary>
    /// Parses the given assembly format string.
    /// </summary>
    /// <param name="format">The assembly format string to parse.</param>
    /// <returns>The parsed <see cref="AssemblyFormatModel"/>.</returns>
    /// <exception cref="FormatException">Thrown when the format string is malformed.</exception>
    public static AssemblyFormatModel Parse(string format)
    {
    ...
    private sealed class Parser
    {
        ...
        public AssemblyFormatModel ParseFormat()
        {
            ...
            return new AssemblyFormatModel(elements);
        }
