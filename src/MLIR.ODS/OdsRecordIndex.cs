...
internal sealed class OdsRecordIndex
{
        ...
        string name, string className, IReadOnlyDictionary<string, Value> fields)
    {
        ...
        // csharpSyntaxShape tells generators how to rewrite the syntax value. Typed syntax
        // properties without an explicit shape are treated as plain values so custom
        // csharpSyntaxType declarations do not accidentally opt into syntax-node rewriting.
