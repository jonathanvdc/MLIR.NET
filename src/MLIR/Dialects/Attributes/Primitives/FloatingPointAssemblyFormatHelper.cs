...
{
    public static ParseResult<AttributeValueSyntax> TryParseDecimalLiteral(ParsingContext context)
    {
        return TryParseDecimalLiteral(context, FloatSemantics.IEEEDouble);
    }

    public static ParseResult<AttributeValueSyntax> TryParseDecimalLiteral(ParsingContext context, FloatSemantics semantics)
    {
    ...
    private static ParseResult<AttributeValueSyntax> TryParseSpecialLiteral(ParsingContext context, FloatSemantics semantics, List<Token> tokens)
    {
    ...
    private static ParseResult<AttributeValueSyntax> TryParseHexLiteral(ParsingContext context, FloatSemantics semantics, List<Token> tokens)
    {
    ...
    private static bool TryParseDecimalLiteralBody(ParsingContext context, List<Token> tokens)
    {
    ...
    private static bool TryParseExponent(ParsingContext context, List<Token> tokens)
    {
        if (!context.TryPeekToken(0, out var kind, out var text) || kind != TokenKind.Identifier)
        {
            return true;
