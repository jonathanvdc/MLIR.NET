...
public sealed class DialectGeneratorRegistrationTests : DialectGeneratorTestBase
{
    ...
    public void GeneratesBuiltinTypeConstraintWrappersAndRegistersSelfIdentifyingOnes()
    {
        ...
        AssertContainsAll(
            ...
            "public sealed partial class IndexConstraintTypeReference : IndexTypeReference",
            "public sealed partial class NoneTypeConstraintTypeReference : NoneTypeReference",
